...
class SplitLayout extends React.Component {
  ...
  onMouseMoved = (e) => {
    ...
    this.calculateMasterPosition(e.clientX)
  ...
  calculateMasterPosition = (mousePos) => {
    ...
    let posStart = cRect.left;
    let posEnd = cRect.right;
    ...
    let slavePos = posEnd - sRect.width - pos;
  ...
  render(){
    ...
    return(
      ...
      >
        ...
        <div className={classes.master + addClass} style={{width:this.state.calculatedPosition}}>
          {childrenDOMs[0]}
        </div>
        ...
        <div className={classes.slave + addClass} style={{width:this.state.calculatedSlavePosition}}>
          {childrenDOMs[1]}
        </div>
